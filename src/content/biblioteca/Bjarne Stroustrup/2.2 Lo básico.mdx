...
nav: {
    back:  "2.1 Introducción",

    next:  "2.2.1 Hello, World!",
...
<img src="/img/libros/cpp-bs/1.png" alt="Diagrama que modela la relación entre el dos códigos fuente y un archivo ejecutable"/>
